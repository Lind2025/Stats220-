...
```
## There we just have a peek of our data
```{r}
## View data structure
...
```
```{r}
paste("From our summary of the survey we know the average passengers number is",summary_values["Avg_Passenger_Count"],"and the overall feedback score of the comfort is",summary_values["Avg_Environment_Rating"])
```
